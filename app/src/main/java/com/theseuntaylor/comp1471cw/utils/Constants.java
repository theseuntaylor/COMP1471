...
public class Constants {
    ...
    public static final String COLUMN_INSTRUMENT_NAME = "instrument name";

    public static final String INSTRUMENT_CREATE = "create table "
            + INSTRUMENTS_TABLE + " ("
            + COLUMN_INSTRUMENT_NAME + " TEXT)";
    ...
    public static final String STERILISATION_MACHINE_CREATE = "create table "
    ...
    // public static final String COLUMN_TRAY_ID = "cleaning_replacement_needed";
    ...
    public static final String CLEANING_PROCESS_CREATE = "create table "
            ...
            + COLUMN_STERILISATION_OFFICER_ID + " STRING, "
